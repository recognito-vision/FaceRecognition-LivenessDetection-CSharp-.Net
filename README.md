...
![Identification](https://github.com/user-attachments/assets/168df0e4-29fb-410a-82a6-2abbe277704c)
...
1. Clone this repository to your local machine:
    ...
    ```
    git clone https://github.com/recognito-vision/FaceRecognition-LivenessDetection-CSharp-.Net.git
    ``` 
...
- Get your HWID and share it with us for trial license.
     ...
     ![HWID](https://github.com/user-attachments/assets/3df31983-367a-4a1b-8a76-4bcbfeee941e)
